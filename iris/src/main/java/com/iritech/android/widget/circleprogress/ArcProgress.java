package com.iritech.android.widget.circleprogress;
...
public class ArcProgress extends View {
    ...
    private int completeStrokeColor;
    ...
    private final int default_complete_color = Color.GREEN;
    ...
    private static final String INSTANCE_COMPLETE_STROKE_COLOR = "complete_stroke_color";
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        completeStrokeColor = attributes.getColor(R.styleable.ArcProgress_arc_complete_color, default_complete_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (progress < 100) {
            ...
            paint.setColor(completeStrokeColor);
        }
...
//        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if(state instanceof Bundle) {
            ...
            completeStrokeColor = bundle.getInt(INSTANCE_COMPLETE_STROKE_COLOR);
